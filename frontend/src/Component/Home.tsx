                ...
                >
                    <motion.div variants={fadeUp}>
                        ...
                        <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                            <div className="flex max-w-md flex-1 items-center gap-2 items-center justify-between rounded-2xl border border-white/10 bg-white/5 p-2">
                                ...
                                />
                                <Button className="rounded-xl bg-gradient-to-r from-indigo-500 to-fuchsia-500 text-white hover:opacity-90">
                                    Join waitlist
                                </Button>
                            </div>
                            <Button
                                className="flex items-center rounded-xl border-white/20 bg-white/5 text-white hover:bg-white/10"
                            >
            ...
            <section className="mx-auto max-w-7xl px-4 pb-8">
                <div className="flex items-center justify-center gap-6 overflow-x-auto py-4 [mask-image:linear-gradient(to_right,transparent,black_10%,black_90%,transparent)]">
                    {logos.map((l) => (
                        <div
                            key={l}
                            className="group flex items-center gap-2 rounded-xl border border-white/5 bg-white/5 px-4 py-2 text-sm text-neutral-300"
                        >
            ...
            <section id="pricing" className="mx-auto max-w-7xl px-4 py-16">
                ...
                <div className="mt-8 grid gap-4 md:grid-cols-3">
                    {plans.map((p) => (
                        <Card
                            key={p.name}
                            className={`relative border-white/10 ${p.highlight
                                ? "bg-gradient-to-b from-neutral-900 to-neutral-900/40 ring-1 ring-fuchsia-500/20"
                                : "bg-neutral-900/40"
                                }`}
                        >
                            {p.highlight && (
                            ...
                            <CardContent>
                                ...
                                <Button
                                    className={`mt-6 w-full ${p.highlight
            ...
            <section className="mx-auto max-w-5xl px-4 pb-20">
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <Faq
                        ...
                        a="Yes. Deadlines and tasks sync automatically with your calendar."
                    />
                    <Faq
                        q="How does pricing work?"
                        a="We price by team size. Start free, upgrade as your team grows."
                    />
                    <Faq
                        q="Do you support Slack/Email?"
                        a="Yes. Tasks and updates flow directly into Slack and email for easy access."
                    />
                </div>
            </section>
                ...
                <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 py-10 md:grid-cols-4">
                    ...
                    <div>
                        ...
                        <div className="mt-3 flex items-center gap-2">
                            <Input
                                placeholder="Work email"
                                className="border-white/10 bg-white/5 text-white placeholder:text-neutral-400"
                            />
